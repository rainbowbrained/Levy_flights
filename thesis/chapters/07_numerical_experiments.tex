...
single-threaded.
Source files: \texttt{levy\_vis\-wa\-na\-than.c} (Viswanathan destructive and non-destructive modes), \texttt{levy\_no\_in\-ter\-rupt.c} (no-interrupt mode), and \texttt{levy\_te\-le\-port.c} (teleport mode).
...
scale.  The source code, raw data, and plotting scripts are
available at
\url{https://github.com/rainbowbrained/Levy_flights};
see Section~\ref{sec:reproducibility} for full reproducibility
details.
