...
\keywords{L\'evy walks, L\'evy flights, random search, optimal foraging, L\'evy foraging hypothesis, mean first-passage time, Monte Carlo simulation, heavy-tailed distributions.}
\begin{abstractpage}
